...
- [x] **GROUP-06**: The "Custom AI Prompt" textarea, brand-tone selector, and productContext / brandTone state are permanently deleted from upload-zone.tsx; the upload call stops sending them.
- [x] **GROUP-07**: Shift-click selects a range within/across groups in visual order, Cmd/Ctrl-click toggles a single thumbnail, plain click selects only that thumbnail; multi-select persists across a drag.
...
| GROUP-08 | Phase 9 | Complete |
| GROUP-09 | Phase 9 | Complete |
| GROUP-10 | Phase 9 | Complete |
| GROUP-11 | Phase 9 | Complete |
| GROUP-12 | Phase 9 | Complete |
