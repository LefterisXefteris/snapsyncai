...
Intel system is disabled. To activate:
  ...
  node /Users/lefterisgilmaz/Desktop/lisai-app/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/lefterisgilmaz/Desktop/lisai-app/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/lefterisgilmaz/Desktop/lisai-app/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/lefterisgilmaz/Desktop/lisai-app/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/lefterisgilmaz/Desktop/lisai-app/.codex/get-shit-done/bin/gsd-tools.cjs
